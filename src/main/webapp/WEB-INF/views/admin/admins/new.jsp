    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h1 class="m-0 font-weight-bold text-primary">
                Dodaj nowe konto administratora<br>
            </h1>
        </div>
        <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4"><br>Wprowadz informacje o nowym administratorze</h1>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm">
                    <div class="form-group form-group--buttons">
                        <button class="btn btn-primary btn-user btn-block" type="submit">Dodaj konto admina</button>
                    </div>
                </div>
            </div>
        </form:form>
